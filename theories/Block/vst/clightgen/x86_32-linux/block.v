  ...
  (Ssequence
    (Ssequence
      ...
      (Sassign
        ...
        (Ecast (Etempvar _t'1 tuint) (talignas 2%N (tptr tvoid)))))
...
Definition f_certicoq_block__copy := {|
  ...
  fn_temps := ((_hd, (tptr tuint)) ::
               ...
               (_field_count, tuint) :: (_i, tuint) :: (_t'3, tuint) ::
               (_t'2, (tptr (talignas 2%N (tptr tvoid)))) ::
               (_t'1, (tptr tuint)) :: (_t'4, (talignas 2%N (tptr tvoid))) ::
               nil);
  fn_body :=
(Ssequence
  (Ssequence
                ...
                (Sset _t'4
                  (Ederef
                    (Ebinop Oadd
                      ...
                      (Etempvar _i tuint) (tptr (talignas 2%N (tptr tvoid))))
