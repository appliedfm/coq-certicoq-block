...
Definition f_certicoq_block__field_iter := {|
  ...
  fn_temps := ((_i, tuint) :: (_hd, (tptr tuint)) :: (_field_count, tuint) ::
               ...
               (_t'3, (tptr (talignas 2%N (tptr tvoid)))) :: (_t'2, tuint) ::
               (_t'1, (tptr tuint)) :: nil);
  fn_body :=
(Ssequence
  (Ssequence
    ...
    (Ssequence
      (Scall (Some _t'2)
        (Evar _certicoq_block__field_count_get (Tfunction
                                                 ...
                                                 tuint cc_default))
        ((Etempvar _hd (tptr tuint)) :: nil))
      (Sset _field_count (Etempvar _t'2 tuint)))
    (Ssequence
      (Sset _i (Econst_int (Int.repr 0) tint))
      (Sloop
        (Ssequence
          ...
          (Ssequence
            (Ssequence
              (Scall (Some _t'3)
                ...
                ((Etempvar _block (tptr (talignas 2%N (tptr tvoid)))) ::
                 (Etempvar _i tuint) :: nil))
              (Sset _x (Etempvar _t'3 (tptr (talignas 2%N (tptr tvoid))))))
            (Scall None
...
Definition f_certicoq_block__field_int_iter := {|
  ...
  fn_temps := ((_i, tuint) :: (_hd, (tptr tuint)) :: (_field_count, tuint) ::
               ...
               (_t'3, (tptr (talignas 2%N (tptr tvoid)))) :: (_t'2, tuint) ::
               (_t'1, (tptr tuint)) :: (_t'5, (talignas 2%N (tptr tvoid))) ::
               nil);
  fn_body :=
(Ssequence
  (Ssequence
        ...
        (Ssequence
          ...
          (Ssequence
            ...
            (Ssequence
              (Ssequence
                (Sset _t'5
                  (Ederef (Etempvar _x (tptr (talignas 2%N (tptr tvoid))))
                    (talignas 2%N (tptr tvoid))))
                (Scall (Some _t'4)
                  ...
                  ((Etempvar _t'5 (talignas 2%N (tptr tvoid))) :: nil)))
