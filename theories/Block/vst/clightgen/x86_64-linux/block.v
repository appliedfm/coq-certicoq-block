...
Definition _certicoq_block__field_int_iter : ident := $"certicoq_block__field_int_iter".
...
Definition f_certicoq_block__init := {|
  ...
  fn_params := ((_dst, (tptr (talignas 3%N (tptr tvoid)))) ::
                (_header, (tptr tulong)) :: nil);
  fn_vars := nil;
  fn_temps := ((_ret, (tptr (talignas 3%N (tptr tvoid)))) :: nil);
  fn_body :=
(Ssequence
  (Sset _ret
    (Ebinop Oadd (Etempvar _dst (tptr (talignas 3%N (tptr tvoid))))
    ...
    (Scall None
      (Evar _certicoq_block__header_set (Tfunction
                                          (Tcons
                                            ...
                                            (Tcons (tptr tulong) Tnil)) tvoid
                                          cc_default))
      ((Etempvar _ret (tptr (talignas 3%N (tptr tvoid)))) ::
       (Etempvar _header (tptr tulong)) :: nil))
    (Sreturn (Some (Etempvar _ret (tptr (talignas 3%N (tptr tvoid))))))))
|}.
...
Definition f_certicoq_block__copy := {|
  ...
  fn_callconv := cc_default;
  fn_params := ((_dst, (tptr (talignas 3%N (tptr tvoid)))) ::
                (_src, (tptr (talignas 3%N (tptr tvoid)))) :: nil);
  fn_vars := nil;
  fn_temps := ((_hd, (tptr tulong)) ::
               (_ret, (tptr (talignas 3%N (tptr tvoid)))) ::
    ...
    (Scall (Some _t'1)
      (Evar _certicoq_block__header_get_ptr (Tfunction
                                              (Tcons
                                                ...
                                                Tnil) (tptr tulong)
                                              cc_default))
      ((Etempvar _src (tptr (talignas 3%N (tptr tvoid)))) :: nil))
    (Sset _hd (Etempvar _t'1 (tptr tulong))))
  (Ssequence
    (Ssequence
      (Scall (Some _t'2)
        (Evar _certicoq_block__init (Tfunction
                                      ...
                                      (tptr (talignas 3%N (tptr tvoid)))
                                      cc_default))
        ((Etempvar _dst (tptr (talignas 3%N (tptr tvoid)))) ::
         (Etempvar _hd (tptr tulong)) :: nil))
      (Sset _ret (Etempvar _t'2 (tptr (talignas 3%N (tptr tvoid))))))
    (Ssequence
      (Ssequence
        (Scall (Some _t'3)
                ...
                (Ssequence
                  (Scall (Some _t'4)
                    (Evar _certicoq_block__field_get (Tfunction
                                                       ...
                                                       cc_default))
                    ((Etempvar _src (tptr (talignas 3%N (tptr tvoid)))) ::
                     (Etempvar _i tulong) :: nil))
                  (Sset _f (Etempvar _t'4 (talignas 3%N (tptr tvoid)))))
                (Scall None
                  ...
                  ((Etempvar _ret (tptr (talignas 3%N (tptr tvoid)))) ::
                   (Etempvar _i tulong) ::
                   (Etempvar _f (talignas 3%N (tptr tvoid))) :: nil))))
            (Sset _i
...
Definition f_certicoq_block__header_get_ptr := {|
  ...
  fn_callconv := cc_default;
  fn_params := ((_block, (tptr (talignas 3%N (tptr tvoid)))) :: nil);
  fn_vars := nil;
  fn_temps := nil;
  fn_body :=
(Sreturn (Some (Ecast
                 (Ebinop Oadd
                   ...
                   (tptr (talignas 3%N (tptr tvoid)))) (tptr tulong))))
|}.

Definition f_certicoq_block__header_set := {|
  fn_return := tvoid;
  fn_callconv := cc_default;
  fn_params := ((_block, (tptr (talignas 3%N (tptr tvoid)))) ::
                (_header, (tptr tulong)) :: nil);
  fn_vars := nil;
  fn_temps := ((_t'1, (talignas 3%N (tptr tvoid))) :: (_t'2, tulong) :: nil);
  fn_body :=
(Ssequence
  (Ssequence
    (Sset _t'2 (Ederef (Etempvar _header (tptr tulong)) tulong))
    (Scall (Some _t'1)
      (Evar _int_or_ptr__of_int (Tfunction (Tcons tlong Tnil)
                                  (talignas 3%N (tptr tvoid)) cc_default))
      ((Etempvar _t'2 tulong) :: nil)))
  (Sassign
    (Ederef
      (Ebinop Oadd (Etempvar _block (tptr (talignas 3%N (tptr tvoid))))
        (Eunop Oneg (Econst_int (Int.repr 1) tint) tint)
...
Definition f_certicoq_block__size_get := {|
  ...
  fn_params := ((_header, (tptr tulong)) :: nil);
  fn_vars := nil;
  fn_temps := ((_one, tulong) :: (_fc, tulong) :: (_t'1, tulong) :: nil);
  fn_body :=
(Ssequence
    ...
    (Ssequence
      (Scall (Some _t'1)
        (Evar _certicoq_block__field_count_get (Tfunction
                                                 ...
                                                 tulong cc_default))
        ((Etempvar _header (tptr tulong)) :: nil))
      (Sset _fc (Etempvar _t'1 tulong)))
    (Sreturn (Some (Ebinop Oadd (Etempvar _one tulong) (Etempvar _fc tulong)
                     tulong)))))
|}.
...
(Ssequence
  (Sset _t'1
    (Ederef
      (Ebinop Oadd (Etempvar _header (tptr tulong))
        (Econst_int (Int.repr 0) tint) (tptr tulong)) tulong))
  (Sreturn (Some (Ebinop Oshr (Etempvar _t'1 tulong)
...
Definition f_certicoq_block__field_count_set := {|
  fn_return := tvoid;
  fn_callconv := cc_default;
  fn_params := ((_header, (tptr tulong)) :: (_size, tulong) :: nil);
  fn_vars := nil;
  fn_temps := ((_mask, tulong) :: (_t'1, tulong) :: nil);
  fn_body :=
(Ssequence
  (Sset _mask
    (Eunop Onotint
    ...
    (Sassign
      (Ederef
        (Ebinop Oadd (Etempvar _header (tptr tulong))
          (Econst_int (Int.repr 0) tint) (tptr tulong)) tulong)
      (Ebinop Oor
        (Ebinop Oand (Etempvar _t'1 tulong) (Etempvar _mask tulong) tulong)
        (Ebinop Oshl (Etempvar _size tulong) (Econst_int (Int.repr 10) tint)
          tulong) tulong))))
|}.
...
Definition f_certicoq_block__tag_set := {|
  fn_return := tvoid;
  fn_callconv := cc_default;
  fn_params := ((_header, (tptr tulong)) :: (_tag, tuchar) :: nil);
  fn_vars := nil;
  fn_temps := ((_mask, tulong) :: (_t'1, tulong) :: nil);
  fn_body :=
(Ssequence
  (Sset _mask
    (Ecast (Eunop Onotint (Econst_int (Int.repr 255) tint) tint) tulong))
  (Ssequence
    (Sset _t'1
      (Ederef
        (Ebinop Oadd (Etempvar _header (tptr tulong))
...
Definition f_certicoq_block__odata_set := {|
  fn_return := tvoid;
  fn_callconv := cc_default;
  fn_params := ((_header, (tptr tulong)) :: (_odata, tuchar) :: nil);
  fn_vars := nil;
  fn_temps := ((_mask, tulong) :: (_t'1, tulong) :: nil);
  fn_body :=
(Ssequence
  (Sset _mask
    (Eunop Onotint
      (Ebinop Oshl (Ecast (Econst_int (Int.repr 3) tint) tulong)
        (Econst_int (Int.repr 8) tint) tulong) tulong))
  (Ssequence
    (Sset _t'1
      (Ederef
        (Ebinop Oadd (Etempvar _header (tptr tulong))
...
(Sreturn (Some (Ebinop Oadd
                 (Etempvar _block (tptr (talignas 3%N (tptr tvoid))))
                 (Etempvar _field tulong) (tptr (talignas 3%N (tptr tvoid))))))
|}.
...
Definition f_certicoq_block__field_set := {|
  ...
  fn_callconv := cc_default;
  fn_params := ((_block, (tptr (talignas 3%N (tptr tvoid)))) ::
                (_field, tulong) :: (_x, (talignas 3%N (tptr tvoid))) :: nil);
  fn_vars := nil;
  fn_temps := nil;
  fn_body :=
(Sassign
  (Ederef
    (Ebinop Oadd (Etempvar _block (tptr (talignas 3%N (tptr tvoid))))
      (Etempvar _field tulong) (tptr (talignas 3%N (tptr tvoid))))
    (talignas 3%N (tptr tvoid))) (Etempvar _x (talignas 3%N (tptr tvoid))))
|}.
...
((___builtin_ais_annot,
 ...
 (_int_or_ptr__of_int,
   Gfun(External (EF_external "int_or_ptr__of_int"
                   (mksignature (AST.Tlong :: nil) AST.Tlong cc_default))
     (Tcons tlong Tnil) (talignas 3%N (tptr tvoid)) cc_default)) ::
 ...
 (_certicoq_block__field_int_iter, Gfun(Internal f_certicoq_block__field_int_iter)) ::
 (_certicoq_block__field_ptr_iter, Gfun(Internal f_certicoq_block__field_ptr_iter)) ::
 nil).

Definition public_idents : list ident :=
(_certicoq_block__field_ptr_iter :: _certicoq_block__field_int_iter ::
 ...
 _int_or_ptr__of_int :: _int_or_ptr__is_int :: ___builtin_debug ::
